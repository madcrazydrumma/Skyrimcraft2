package net.skyrimcraft.src.dimension.provider;
...
public class SovngardeWorldProvider extends WorldProvider {
	private float[] colorsSunriseSunset = new float[4];

	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(BiomeGenBase.extremeHills, this.dimensionId, this.dimensionId);
		this.dimensionId = 20;
		this.hasNoSky = false;
	}

	public IChunkProvider createChunkGenerator() {
		return new SovngardeChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	public String getWelcomeMessage() {
		if ((this instanceof SovngardeWorldProvider)) {
