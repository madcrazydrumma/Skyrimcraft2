...
public class GuiClearButton extends GuiButton
{
    ...
    public GuiClearButton(int par1, int par2, int par3, String par4Str)
    {
        this(par1, par2, par3, 200, 20, par4Str);
    }
    
    public GuiClearButton(int par1, int par2, int par3, int par4, int par5, String par6Str)
    {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3)
    {
        if (this.drawButton)
        {
            ...
            if(this.getHoverState(false) == 1) {
            	this.drawCenteredString(var4, this.displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, var6);
            } else if(this.getHoverState(true) == 2) {
            	GL11.glPushMatrix();
