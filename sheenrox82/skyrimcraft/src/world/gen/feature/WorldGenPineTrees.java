package sheenrox82.skyrimcraft.src.world.gen.feature;
...
public class WorldGenPineTrees extends WorldGenerator
{
    public WorldGenPineTrees(boolean par1)
    {
        super(par1);
    }
            ...
            else
            {
                ...
                if (isValidSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j3 = 0; j3 < l - j2; ++j3)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j3, par5, Block.wood.blockID, 0);
                        }
                    }
